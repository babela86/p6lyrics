...
public class GetLyricResult implements java.io.Serializable {
	...
	public GetLyricResult(java.lang.String trackChecksum, int trackId,
			java.lang.String lyricChecksum, int lyricId,
			java.lang.String lyricSong, java.lang.String lyricArtist,
			java.lang.String lyricUrl, java.lang.String lyricCovertArtUrl,
			int lyricRank, java.lang.String lyricCorrectUrl,
	...
	@Override
	 public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof GetLyricResult))
			return false;
		...
		boolean _equals;
		_equals = true
				&& ((this.trackChecksum == null && other.getTrackChecksum() == null) || (this.trackChecksum != null && this.trackChecksum
						.equals(other.getTrackChecksum())))
				&& this.trackId == other.getTrackId()
				&& ((this.lyricChecksum == null && other.getLyricChecksum() == null) || (this.lyricChecksum != null && this.lyricChecksum
						.equals(other.getLyricChecksum())))
				&& this.lyricId == other.getLyricId()
				&& ((this.lyricSong == null && other.getLyricSong() == null) || (this.lyricSong != null && this.lyricSong
						.equals(other.getLyricSong())))
				&& ((this.lyricArtist == null && other.getLyricArtist() == null) || (this.lyricArtist != null && this.lyricArtist
						.equals(other.getLyricArtist())))
				&& ((this.lyricUrl == null && other.getLyricUrl() == null) || (this.lyricUrl != null && this.lyricUrl
						.equals(other.getLyricUrl())))
				&& ((this.lyricCovertArtUrl == null && other
						.getLyricCovertArtUrl() == null) || (this.lyricCovertArtUrl != null && this.lyricCovertArtUrl
						.equals(other.getLyricCovertArtUrl())))
				&& this.lyricRank == other.getLyricRank()
				&& ((this.lyricCorrectUrl == null && other.getLyricCorrectUrl() == null) || (this.lyricCorrectUrl != null && this.lyricCorrectUrl
						.equals(other.getLyricCorrectUrl())))
				&& ((this.lyric == null && other.getLyric() == null) || (this.lyric != null && this.lyric
						.equals(other.getLyric())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			GetLyricResult.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "GetLyricResult"));
		org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("trackChecksum");
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "TrackChecksum"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "TrackId"));
		elemField.setXmlType(new javax.xml.namespace.QName(
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricChecksum"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricId"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "int"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricSong"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricArtist"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricUrl"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricCovertArtUrl"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricRank"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "int"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "LyricCorrectUrl"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://api.chartlyrics.com/", "Lyric"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
